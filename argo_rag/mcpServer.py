...
def ask_llm(question: str):
    ...
    sql_response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"keep in mind if question mentions month or year or date or float id, argo id you can find it in ad_observation_id column which has entries like this 1900042_04/01/2004. so extract id and date accordingly. Write a SQL query to answer: {question}"}
        ]
    )
